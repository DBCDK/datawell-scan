...
public class Arguments {
    ...
    public Arguments(String... args) throws ExitException {
        this.options = new Options()
                ...
                .addOption(this.db = Option.builder("d")
                        ...
                        .desc("Database url")
                        .build())
                .addOption(this.solrDocStore = Option.builder("S")
                        .longOpt("solr-doc-store-database")
                        .hasArg()
                        .required()
                        .argName("DB")
                        .desc("Database url to solr-doc-store")
                        .build())
                .addOption(this.batchSize = Option.builder("b")
                        .longOpt("batch-size")
                        .hasArg()
                        .argName("NUM")
                        .desc("Now many enqueues to batch together (0 is all, default is 10000)")
                        .build())
                .addOption(this.solr = Option.builder("s")
                        .longOpt("solr")
                        .hasArg()
                        .required()
                        .argName("URL")
                        .desc("Url of solr-collection to fetch pids from")
                        .build())
                .addOption(this.queue = Option.builder("Q")
                        .longOpt("queue")
                        .hasArg()
                        .argName("NAME")
    ...
    public String getSolrDocStoreDb() {
        return getOpt(solrDocStore, null);
    }

    public String getSolrUrl() {
        return getOpt(solr, null);
    }
